...
<html lang="es">
<head>
    <title>Registro - Tecno Store</title>
        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">Tecno Store Colombia</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <img src="assets/img/registroimagen.png" alt="electrodomesticos" class="img-responsive">
                </div>
                       ...
                       <form class="form-horizontal FormCatElec" action="process/regclien.php" role="form" method="post" data-form="save">
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su número de NIT, Cedula o Pasaporte" required name="clien-nit" data-toggle="tooltip" data-placement="top" title="Ingrese su número de NIT, Cedula o Pasaporte, registrando solamente números y guiones(-)" maxlength="30" pattern="[0-9-]{14,30}">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="password" placeholder="Registre una contraseña" required name="clien-pass" data-toggle="tooltip" data-placement="top" title="Defina una contraseña para iniciar sesión">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="text" placeholder="Ingrese su dirección de residencia" required name="clien-dir" data-toggle="tooltip" data-placement="top" title="Ingrese su dirección de residencia" maxlength="100">
                              </div>
                            </div>
                            <br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <div class="input-group">
                                ...
                                <input class="form-control all-elements-tooltip" type="email" placeholder="Registre su Email" required name="clien-email" data-toggle="tooltip" data-placement="top" title="Ingrese la dirección de correo electronico personal o corporativo." maxlength="50">
                              </div>
                            </div>
                            <br>
                            <p><button type="submit" class="btn btn-success btn-block"><i class="fa fa-pencil"></i>&nbsp; Registrarse en Tecno Store Colombia</button></p>
