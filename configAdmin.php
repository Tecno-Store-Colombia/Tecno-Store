    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">Tecno Store Colombia</small></h1>
            </div>
            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#Productos" role="tab" data-toggle="tab">Administrar Productos</a></li>
              <li role="presentation"><a href="#Proveedores" role="tab" data-toggle="tab">Administrar Proveedores</a></li>
              <li role="presentation"><a href="#Categorias" role="tab" data-toggle="tab">Administrar Categorías</a></li>
              <li role="presentation"><a href="#Admins" role="tab" data-toggle="tab">Administracion Usuarios</a></li>
              <li role="presentation"><a href="#Pedidos" role="tab" data-toggle="tab">Pedidos de Clientes</a></li>
            </ul>
                ...
                <div role="tabpanel" class="tab-pane fade" id="Pedidos">
                    <div class="row">
                        <div class="col-xs-12">
                            <br><br>
                            <div id="del-pedido">
                                <h2 class="text-danger text-center"><small><i class="fa fa-trash-o"></i></small>&nbsp;&nbsp;Eliminar Pedido Seleccionado</h2>
                                <form action="process/delPedido.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Pedidos por Clientes</label>
                            ...
                            <br><br>
                             <div class="panel panel-info">
                               <div class="panel-heading text-center"><i class="fa fa-refresh fa-2x"></i><h3>Listado de Pedidos</h3></div>
                              <div class="table-responsive">
                                  <table class="table table-bordered">
                                      <thead class="">
                                          <tr>
            ...
            <tr>
                ...
                <td>';
                    ...
                    while($UsP=mysql_fetch_array($conUs)){
                       echo $UsP['Nombre'];
                        $consultaCliente = "SELECT * FROM cliente WHERE Nombre = '".$UsP['Nombre']."'";
                        $resultadoCliente = mysql_query($consultaCliente);
                        echo '<table class="table table-bordered">
                            ...
                            <tbody>';
                        while ($filaCliente = mysql_fetch_assoc($resultadoCliente)) {
                            echo '<tr>
                                <td>'.$filaCliente['NIT'].'</td>
                                <td>'.$filaCliente['NombreCompleto'].'</td>
                                <td>'.$filaCliente['Apellido'].'</td>
                                <td>'.$filaCliente['Direccion'].'</td>
                                <td>'.$filaCliente['Telefono'].'</td>
                                <td>'.$filaCliente['Email'].'</td>
                            </tr>';
                        }
                        echo '</tbody></table>';
                    }
...
<script>
// Función para consultar cliente mediante AJAX
function consultarCliente(nombreCliente) {
    $.ajax({
        type: "POST",
        url: "process/consultarCliente.php",
        data: { nombreCliente: nombreCliente },
        success: function(response) {
            // Manejar la respuesta y mostrar la tabla de información del cliente
            $('#info-cliente').html(response);
        }
    });
}
</script>
